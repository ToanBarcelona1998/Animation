...
class CustomChart extends CustomPainter {
  ...
  void drawAxes(Canvas canvas, Size size, Paint axis,Paint axisLight,) {
    // vẽ line trục ngang
    canvas.drawLine(
  ...
  TextPainter createText(String title, double scale) {
    TextSpan textSpan = TextSpan(text: title, style: TextStyle(color: Colors.grey[600],fontWeight: FontWeight.w700,fontSize: 14));
    TextPainter tp =
