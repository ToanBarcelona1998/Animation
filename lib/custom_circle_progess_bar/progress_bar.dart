...
import 'custom_circle_progess.dart';

enum ProgressHudType {
  /// hiển thị trạng thái loading và text
  loading,

  /// hiển thị icon hoàn thành
  success,

  /// hiển thị icon và đóng văn bản
  error,

  /// hiển thị tiến trình dạng hình tròn, văn bản, giao diện
  progress
}
...
/// Hiển thị trạng thái Hub
class ProgressHud extends StatefulWidget {
  /// Chiều dọc (height) of hudview vị trí từ center, default is -50
  ...
  ProgressHud(
      {Key ?key,
        ...
        required this.maximumDismissDuration})
      : super(key: key);
