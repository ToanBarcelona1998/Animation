...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _listStartValue = [_heightContainer / 2 + 20, _heightContainer / 2 + 20, _heightContainer / 2 + 20];
    ...
    _controller2 = AnimationController(vsync: this, duration: Duration(milliseconds: 1100))..addListener(() {
    ...
    _animation = Tween(begin: _listStartValue![0], end: _heightContainer / 2)
        .animate(CurvedAnimation(parent: _controller!, curve: Curves.decelerate))
      ..addListener(loadAnimation);
    _animation1 = Tween(begin: _listStartValue![1], end: _heightContainer / 2 )
        .animate(CurvedAnimation(parent: _controller1!, curve: Curves.decelerate))
      ..addListener(loadAnimation1);
    _animation2 = Tween(begin: _listStartValue![2], end: _heightContainer / 2 )
